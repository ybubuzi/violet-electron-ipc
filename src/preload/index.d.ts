...
type ExcludeIpcEvent<T extends AnyFunction> = Exclude<Parameters<T>, import('electron').IpcMainInvokeEvent>;
type ApiInvokeFunction<T extends AnyFunction> = (...args: ExcludeIpcEvent<T>) => Promise<UnwrapPromise<ReturnType<T>>>;
